...
public class ObjectFactory {
    ...
    private final static QName _GetUserResponse_QNAME = new QName("http://webservice/", "getUserResponse");
    private final static QName _GetUser_QNAME = new QName("http://webservice/", "getUser");
    private final static QName _RegisterUser_QNAME = new QName("http://webservice/", "registerUser");
    private final static QName _RegisterUserResponse_QNAME = new QName("http://webservice/", "registerUserResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "getUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "getUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "registerUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "registerUserResponse")
