 ...
 * 
 */
@WebServiceClient(name = "RegistrationService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8080/Registration/?WSDL")
    ...
    extends Service
{
    ...
    private final static QName REGISTRATIONSERVICE_QNAME = new QName("http://webservice/", "RegistrationService");
    ...
    public Registration getRegistrationPort() {
        return super.getPort(new QName("http://webservice/", "RegistrationPort"), Registration.class);
    }
    ...
    public Registration getRegistrationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "RegistrationPort"), Registration.class, features);
    }
