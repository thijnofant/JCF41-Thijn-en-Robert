 ...
 * @author Robert
 */
class TextFieldTree extends TreeCell<Afdeling> {

    private TextField textField;
    private TreeView<Afdeling> treeView;
 
    public TextFieldTree(TreeView<Afdeling> tv) {
        this.treeView = tv;
    }
    ...
    @Override
    public void updateItem(Afdeling item, boolean empty) {
